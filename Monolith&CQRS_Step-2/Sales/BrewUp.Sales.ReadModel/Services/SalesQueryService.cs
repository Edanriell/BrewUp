...
public sealed class SalesQueryService(ILoggerFactory loggerFactory, IQueries<SalesOrder> queries)
    : ServiceBase(loggerFactory), ISalesQueryService
{
    public async Task<PagedResult<SalesOrderJson>> GetSalesOrdersAsync(
