...
public sealed class WarehousesFacade(
    IWarehousesDomainService warehousesDomainService,
    IAvailabilityQueryService availabilityQueryService) : IWarehousesFacade
{
