...
using SalesOrder = BrewUp.Shared.Entities.SalesOrder;
...
public static class DomainHelper
{
    ...
    internal static SalesOrder MapToSharedDto(this Entities.Sales.SalesOrder salesOrder)
    {
    ...
    internal static Availability MapToSharedDto(this Entities.Warehouses.Availability availability)
    {
